...
export default function Home() {
  return (
    <main className="bg-[#222]">
      ...
      <section className="relative h-screen w-screen overflow-hidden bg-[#222]">
        ...
        <Shader className="scale-[1.15] sm:scale-105 lg:scale-125 absolute w-full h-full top-0 right-0 z-10 animate-blur-in pointer-events-none bg-[#222]" />
      </section>
    </main>
  );
}
